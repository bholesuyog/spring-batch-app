...
public class SpringBatchConfiguration {
	...
	public Step step(JobRepository repository, PlatformTransactionManager transactionManager) {
		return new StepBuilder("csv-step", repository).<Customer, Customer>chunk(10, transactionManager)
				.reader(reader())
				.processor(processor())
				.writer(writer())
	...
	@Bean(name = "csvJob")
	public Job run(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
